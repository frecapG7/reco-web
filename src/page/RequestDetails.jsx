import { Accordion, AccordionDetails, AccordionSummary, Avatar, Box, Card, CardActions, CardContent, CardHeader, Collapse, Divider, Icon, IconButton, Paper, Typography } from "@mui/material";
        ...
        <Container>
            ...
            <Card>
                <CardHeader avatar={
                    ...
                    title={
                        <Typography>
                            John Doe <Enum value={request.requestType} enumName="REQUEST_TYPE" />
                        </Typography>
                    }
                    action={<Button aria-label="actions" variant="contained"> {request.status}</Button>}
                >
                    toto l'asticot
                </CardHeader>
                <CardContent>
